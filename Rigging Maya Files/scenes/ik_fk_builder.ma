...
//Last modified: Thu, May 07, 2026 12:35:19 AM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "909B958A-4A2D-4212-9DDE-6C9E5D3BF725";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "F64654FE-417E-60AC-FC09-09915981D44C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.292230600965196 12.135768033649098 23.588700304483172 ;
	setAttr ".r" -type "double3" -8.7383527368341003 -1085.0000000010448 4.9885998182023977e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "549EF3E7-4D68-6E0E-00C7-EBA48E1DC3AF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 24.414848803521455;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 12.900691751588973 7.6059956587077302 -0.13118122279668309 ;
...
createNode joint -n "left_Wrist_Jnt" -p "left_Elbow_Jnt";
	...
	setAttr ".t" -type "double3" 5.6600597206177099 -1.6875389974302379e-14 8.8817841970012523e-16 ;
	setAttr ".r" -type "double3" 0 -3.1805546814635168e-15 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
