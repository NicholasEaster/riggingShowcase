...
//Last modified: Mon, Aug 17, 2026 08:25:17 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "206DFF08-4F95-05E0-5517-23A81599CA34";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "F64654FE-417E-60AC-FC09-09915981D44C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 30.249996851552751 17.862548388301406 -1.8692707905616324 ;
	setAttr ".r" -type "double3" -22.538352747134301 -618.59999999992056 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "549EF3E7-4D68-6E0E-00C7-EBA48E1DC3AF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 22.049403244204399;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.93178226178079893 9.1059956587077302 0.7721982888884984 ;
...
createNode joint -n "left_Elbow_Jnt" -p "left_Shoulder_Jnt";
	...
	setAttr ".t" -type "double3" 5.4096717302534465 0 -2.7755575615628914e-15 ;
	setAttr ".r" -type "double3" 0 3.1805546814635168e-15 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "left_Wrist_Jnt" -p "left_Elbow_Jnt";
	...
	setAttr ".t" -type "double3" 5.6600597206177099 -1.865174681370263e-14 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "left_Pinky02_Jnt" -p "left_Pinky01_Jnt";
	...
	setAttr ".t" -type "double3" 1.1105457791101134 0 2.2204460492503131e-16 ;
...
createNode transform -n "left_Wrist_JntControlGrp";
	rename -uid "C90DB3CA-4C65-FDC0-4726-CA97570D1A43";
	setAttr ".t" -type "double3" 13.542635838891195 7.6059956587077115 0.022398149384756039 ;
	setAttr ".r" -type "double3" 0 1.269600023694593 0 ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "32113F78-4060-A5D7-05D9-2A80341AF694";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "88F7EA26-4AB3-0500-FDC1-C6808C4B64C1";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "478A1665-4781-B5B8-5EF3-03A8CB996F51";
createNode displayLayerManager -n "layerManager";
	rename -uid "29704EED-4DEC-6E5B-0AC9-92B3B502E70B";
	setAttr ".cdl" 5;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "D26E0722-4DEA-D4FE-8C1A-01A30A5B7E27";
