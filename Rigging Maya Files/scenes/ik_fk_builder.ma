...
//Last modified: Wed, May 06, 2026 10:25:10 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "5E40EC8F-4105-53D7-4D87-BA96A7320DC8";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "F64654FE-417E-60AC-FC09-09915981D44C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 18.050311512413881 9.5650163167419411 10.910770704818896 ;
	setAttr ".r" -type "double3" 2.061647265400103 -1058.999999998834 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "549EF3E7-4D68-6E0E-00C7-EBA48E1DC3AF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 12.255667541855953;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 12.03462929726785 7.6059956587077284 0.84030468558296345 ;
...
createNode joint -n "left_Pinky02_Jnt" -p "left_Pinky01_Jnt";
	...
	setAttr ".t" -type "double3" 1.1105457791101117 0 0 ;
...
createNode joint -n "left_PinkyEnd_Jnt" -p "left_Pinky03_Jnt";
	...
	setAttr ".t" -type "double3" 1.0346888806951817 -8.8817841970012523e-16 5.5511151231257827e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 -66.556592835690594 0 ;
	setAttr ".radi" 0.50179425244975062;
createNode parentConstraint -n "left_Wrist_Jnt_parentConstraint1" -p "left_Wrist_Jnt";
	rename -uid "696F7F5A-44E3-C7D0-84CB-019F4EB6216B";
	addAttr -dcb 0 -ci true -k true -sn "w0" -ln "left_Wrist_JntControlW0" -dv 1 -min 
		0 -at "double";
	setAttr -k on ".nds";
	setAttr -k off ".v";
	setAttr -k off ".tx";
	...
	setAttr ".rst" -type "double3" 5.660059720617709 -1.4210854715202004e-14 8.8817841970012523e-16 ;
	setAttr ".rsrr" -type "double3" 0 -3.1805546814635168e-15 0 ;
	setAttr -k on ".w0";
createNode transform -n "left_Wrist_JntControlGrp";
	rename -uid "DF47DBF5-4E34-68C4-7AC9-C3892EAD9073";
	setAttr ".t" -type "double3" 13.542635838891194 7.605995658707716 0.022398149384758481 ;
	setAttr ".r" -type "double3" 0 1.2696000236945915 0 ;
createNode transform -n "left_Wrist_JntControl" -p "left_Wrist_JntControlGrp";
	rename -uid "962CFF56-4D60-B1CC-B213-CDB2E0EC293F";
createNode nurbsCurve -n "curveShape1" -p "left_Wrist_JntControl";
	rename -uid "BF2FA56D-4DCE-0921-69FB-DA8A911C9111";
	setAttr -k off ".v";
	setAttr ".ove" yes;
	setAttr ".ovrgbf" yes;
	setAttr ".ovrgb" -type "float3" 0.050000001 0 0.60000002 ;
	setAttr ".cc" -type "nurbsCurve" 
		1 7 0 no 3
		8 0 1 2 3 4 5 6 7
		8
		0 1 0
		0 1.3333333333333333 0.33333333333333331
		0 1.3333333333333333 0.16666666666666666
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B2CAC04D-4C4F-F1B1-B46E-AFAC3F094764";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "EE0F6758-4FE2-2C19-DBDC-608A8C994DAC";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F812F5DA-43F2-0083-BAFE-ACAB9FF7B9F5";
createNode displayLayerManager -n "layerManager";
	rename -uid "E3FC7773-44CF-FD7D-D5F3-72BEB064E1DF";
	setAttr ".cdl" 5;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "F36D0B96-48D9-47B1-2C9E-56B71554F617";
...
connectAttr "left_Wrist_Jnt_parentConstraint1.ctx" "left_Wrist_Jnt.tx";
connectAttr "left_Wrist_Jnt_parentConstraint1.cty" "left_Wrist_Jnt.ty";
connectAttr "left_Wrist_Jnt_parentConstraint1.ctz" "left_Wrist_Jnt.tz";
connectAttr "left_Wrist_Jnt_parentConstraint1.crx" "left_Wrist_Jnt.rx";
connectAttr "left_Wrist_Jnt_parentConstraint1.cry" "left_Wrist_Jnt.ry";
connectAttr "left_Wrist_Jnt_parentConstraint1.crz" "left_Wrist_Jnt.rz";
...
connectAttr "left_Wrist_Jnt.ro" "left_Wrist_Jnt_parentConstraint1.cro";
connectAttr "left_Wrist_Jnt.pim" "left_Wrist_Jnt_parentConstraint1.cpim";
connectAttr "left_Wrist_Jnt.rp" "left_Wrist_Jnt_parentConstraint1.crp";
connectAttr "left_Wrist_Jnt.rpt" "left_Wrist_Jnt_parentConstraint1.crt";
connectAttr "left_Wrist_Jnt.jo" "left_Wrist_Jnt_parentConstraint1.cjo";
connectAttr "left_Wrist_JntControl.t" "left_Wrist_Jnt_parentConstraint1.tg[0].tt"
		;
connectAttr "left_Wrist_JntControl.rp" "left_Wrist_Jnt_parentConstraint1.tg[0].trp"
		;
connectAttr "left_Wrist_JntControl.rpt" "left_Wrist_Jnt_parentConstraint1.tg[0].trt"
		;
connectAttr "left_Wrist_JntControl.r" "left_Wrist_Jnt_parentConstraint1.tg[0].tr"
		;
connectAttr "left_Wrist_JntControl.ro" "left_Wrist_Jnt_parentConstraint1.tg[0].tro"
		;
connectAttr "left_Wrist_JntControl.s" "left_Wrist_Jnt_parentConstraint1.tg[0].ts"
		;
connectAttr "left_Wrist_JntControl.pm" "left_Wrist_Jnt_parentConstraint1.tg[0].tpm"
		;
connectAttr "left_Wrist_Jnt_parentConstraint1.w0" "left_Wrist_Jnt_parentConstraint1.tg[0].tw"
		;
