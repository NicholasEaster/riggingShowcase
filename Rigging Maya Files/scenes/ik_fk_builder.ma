...
//Last modified: Tue, Aug 18, 2026 07:38:40 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "DB444F94-447E-5D4B-7868-4F8686B294AA";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "F64654FE-417E-60AC-FC09-09915981D44C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 24.067050540276867 19.411396537976966 18.451373404250962 ;
	setAttr ".r" -type "double3" -24.938352746810878 -690.19999999988227 -9.163059756295276e-16 ;
...
createNode joint -n "left_Wrist_Jnt" -p "left_Elbow_Jnt";
	...
	setAttr ".t" -type "double3" 5.6600597206177099 -1.9539925233402755e-14 -4.4408920985006262e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9F8F84DB-4CD6-1495-A00F-C0B7290F74C1";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C383C58B-4DE6-C6EA-73C8-A185B88872D5";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "FAFFC6A7-49A3-304D-AF73-CEB03BCCEFFF";
createNode displayLayerManager -n "layerManager";
	rename -uid "5D4FF352-4770-722F-A7F9-B599B722DA2B";
	setAttr ".cdl" 5;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "FEAEBF37-47D3-3326-AE4C-93B8375C899B";
