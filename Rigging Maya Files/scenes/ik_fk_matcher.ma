...
//Name: ik_fk_matcher.ma
//Last modified: Sat, Apr 04, 2026 05:27:58 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "0C0B2961-4CC1-7457-E5C9-82A8EC3EC302";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "F64654FE-417E-60AC-FC09-09915981D44C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.3422807187801151 20.831514926878256 35.124083358891326 ;
	setAttr ".r" -type "double3" -20.738352729620214 -1.8000000000010601 -4.9720701062415274e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "549EF3E7-4D68-6E0E-00C7-EBA48E1DC3AF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 36.707642094227737;
...
createNode joint -n "left_PinkyEnd_Jnt" -p "left_Pinky03_Jnt";
	...
	setAttr ".radi" 0.50179425244975062;
createNode transform -n "pasted__Backdrop";
...
createNode mesh -n "pasted__BackdropShape" -p "pasted__Backdrop";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "25F566AF-4574-F916-D7B6-E6BAE56E0FE4";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "24E017DD-4142-EDE6-AD82-E48939016C2B";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "30D47569-4447-1AF1-C09B-3F9E80824539";
createNode displayLayerManager -n "layerManager";
	rename -uid "CE4FC6E6-424E-CB7D-7410-289BCE6E5A02";
	setAttr ".cdl" 5;
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9FA08C32-46CF-CEF5-3BAB-009157C44571";
...
connectAttr "backdropLayer.di" "pasted__Backdrop.do";
...
connectAttr "pasted__BackdropShape.iog" "pasted__lambert3SG.dsm" -na;
